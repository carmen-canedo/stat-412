...
## Note: if I had more time, I would fix the issue with the y scale on the organic facet - tried using "free_y" but wasn't changing
...
## Ran into error when trying to use col_factor()
